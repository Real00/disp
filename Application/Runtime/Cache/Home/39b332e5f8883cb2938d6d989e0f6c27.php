...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/disp/Public/Css/bg.css" />
                    ...
                    if(ajax.readyState==4 &&ajax.status==200 ){
                        ...
                        for(var i=0 ;i<data.length;i++){
                            str = str+"<tr>"+
                                ...
                                "<td>GPS坐标：" +"<a href='map?mp="+data[i]['ugps']+"'>"+data[i]['ugps']+"</a></td>"+
...
<div class="row">
    <div class="col-md-12" style="background: #000000">
        ...
        <div class="col-md-2">
            <div class="row"><a href="<?php echo U('history');?>"><button class="btn btn-primary">查询历史记录</button></a><button id="Qu" class="btn btn-primary" >连接服务器</button></div>
        </div>
    </div>
</div>
<div class="row">
